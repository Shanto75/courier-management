...
<div id="clone_timeline-item" class="d-none">
    <div class="iitem row ">
		...
		<div class="col">
			...
			<p class="ridername badge badge-pill badge-success"></p>
			<p class="ridername2 badge badge-pill badge-danger"></p>
		</div>
    </div>
</div>
<script>
                ...
                if (typeof resp === 'object' || Array.isArray(resp) || typeof JSON.parse(resp) ===
                    ...
                    if (Object.keys(resp).length > 0) {
                        ...
                        Object.keys(resp).map(function(k) {
                            ...
                            if (resp[k].status === 'Delivered') {
                                tl.find('.ridername').text("Rider: " + resp[k].ridername)
                            }if (resp[k].status === 'Unsuccessfull Delivery Attempt/Return') {
                                tl.find('.ridername2').text("Rider: " + resp[k].ridername)
                            }
