	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$qry = $conn->query("SELECT MIN(id) AS id, reference_number, sender_name, sender_contact, sender_address, recipient_name, recipient_contact, recipient_address, type, from_branch_id, to_branch_id, date_created FROM parcels GROUP BY date_created DESC");
