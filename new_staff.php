          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">First Name/ Shop or Page Name</label>
                <input type="text" name="firstname" id="" class="form-control form-control-sm" value="<?php echo isset($firstname) ? $firstname : '' ?>" required>
              </div>
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Last Name/ Owner Name</label>
              ...
              <div class="col-sm-6 form-group ">
                ...
                <input type="text" name="staff_id" id="" class="form-control form-control-sm" value="<?php echo isset($staff_id) ? $staff_id : '' ?>" required>
              </div>
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                ...
                <select name="branch_id" id="" class="form-control input-sm select2">
                  <option value=""></option>
                  <?php
                    $branches = $conn->query("SELECT *,concat(branch_name,', ',address,', ',station,', ',country) as address FROM branches");
