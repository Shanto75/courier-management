...
<?php
    ...
    $reference_number = "F0". rand(100000,999999);
?>
<style>
  textarea{
    resize: none;
	...
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="sender_name" id="" class="form-control form-control-sm" value="<?php echo isset($sender_name) ? $sender_name : $_SESSION['login_name'] ?>" required>
                <input type="hidden" name="user_id" id="user_id" class="form-control form-control-sm" value="<?php echo $_SESSION['login_id']; ?>" required>
              </div>
              <div class="form-group">
                <label for="" class="control-label">Address</label>
                <input type="text" name="sender_address" id="" class="form-control form-control-sm" value="<?php echo isset($sender_address) ? $sender_address : $_SESSION['login_address'] ?>" required>
              </div>
              <div class="form-group">
                <label for="" class="control-label">Contact #</label>
                <input type="text" name="sender_contact" id="" class="form-control form-control-sm" value="<?php echo isset($sender_contact) ? $sender_contact : $_SESSION['login_phone'] ?>" required>
              </div>
              <div class="form-group">
                <label for="" class="control-label">Merchant Order ID</label>
                <input type="text" name="merchant_order_id" id="" class="form-control form-control-sm" value="<?php echo isset($merchant_order_id) ? $merchant_order_id : '' ?>">
              </div>
          </div>
          <div class="col-md-6">
              <b>Recipient Information</b><hr>
              <div class="form-group">
                <label for="" class="control-label">Name</label>
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="reference_number" id="" class="form-control form-control-sm" value="<?php echo isset($reference_number) ? $reference_number : '' ?>" required>  
              </div>
              <div class="form-group">
                <label for="" class="control-label">Address</label>
              ...
              <div class="form-group">
                ...
                <input type="text" name="station" id="" class="form-control form-control-sm" value="<?php echo isset($station) ? $station : '' ?>" required>
              </div>
              <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <h3><b>Parcel Reference Number:</b> <span class="badge badge-pill badge-info"><?php echo $reference_number; ?></span> </h3>
          </div>
          <div class="col-md-6" id=""  <?php echo isset($type) && $type == 1 ? 'style="display: none"' : '' ?>>
            <div class="row">
                <div class="col-md-6">
                    <label for="" class="control-label">Delivery Cost</label>
                    <input type="number" placeholder="00" name="delivery_cost" id="delivery_cost" class="form-control form-control-sm" value="<?php echo isset($delivery_cost) ? $delivery_cost : '' ?>" required>
                </div>
                <div class="col-md-6">
                    <label for="" class="control-label">COD</label>
                    <input type="number" placeholder="00" name="cod" id="cod" class="form-control form-control-sm" value="<?php echo isset($cod) ? $cod : '' ?>" required>
                </div>
                <div class="col-md-6">
                    <label for="" class="control-label">Delivery Time</label>
                    <select name="delivery_within" id="delivery_within" class="form-control select2"  required>
                        <option value="0">Regular</option>
                        <option value="6">6 Hours</option>
                        <option value="12">Same Day</option>
        ...
        <table class="table table-bordered" id="parcel-items">
          ...
          <tbody>
            <tr>
              <td><input class="form-control form-control-sm" type="text" name='item_name[]' value="<?php echo isset($item_name) ? $item_name :'' ?>" required></td>
              <td><input class="form-control form-control-sm" type="text" name='weight[]' value="<?php echo isset($weight) ? $weight :'' ?>" required></td>
              <td><input class="form-control form-control-sm" type="text" name='height[]' value="<?php echo isset($height) ? $height :'' ?>"></td>
              <td><input class="form-control form-control-sm" type="text" name='length[]' value="<?php echo isset($length) ? $length :'' ?>"></td>
              <td><input class="form-control form-control-sm" type="text" name='width[]' value="<?php echo isset($width) ? $width :'' ?>"></td>
              <td><input class="form-control form-control-sm" type="text" class="text-right number" name='price[]' value="<?php echo isset($price) ? $price :'' ?>" required></td>
              <?php if(!isset($id)): ?>
        ...
        <div class="mb-3 col-md-6">
          ...
          <textarea class="form-control" name="note" id="note" rows="3" value="<?php echo isset($note) ? $note : '' ?>"></textarea>
        </div>
              <?php endif; ?>
      </form>
  	</div>
...
<div id="ptr_clone" class="d-none">
  <table>
    <tr>
        ...
        <td><input class="form-control form-control-sm" type="text" class="text-right number" name='price[]' required></td>
        <td><button class="btn btn-sm btn-danger" type="button" onclick="$(this).closest('tr').remove() && calc()"><i class="fa fa-times"></i></button></td>
      </tr>
  </table>
</div>
