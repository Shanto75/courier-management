...
<div class="row m-auto">
    <div class="col-12 col-sm-6 col-md-6">
        <div class="small-box bg-success shadow-sm border">
            <div class="inner">
                <h3><?php echo $conn->query("SELECT * FROM parcels WHERE riderid='".$_SESSION['login_id']."'")->num_rows; ?>
                </h3>
                <p>Total Parcels</p>
            </div>
            <div class="icon">
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="small-box bg-secondary shadow-sm border">
            <div class="inner">
                ...
                <h3><?php echo($conn->query("SELECT COUNT( DISTINCT reference_number) as rfnum FROM parcels where status = $k+1 and riderid='".$_SESSION['login_id']."'")->fetch_array()[0]); ?>
                </h3>
