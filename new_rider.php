          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                ...
                <input type="hidden" name="type" id="type" class="form-control form-control-sm" value="4" required>
              </div>
              <div class="col-sm-6 form-group ">
              ...
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Rider Staff Id</label>
                <input type="text" name="staff_id" id="staff_id" class="form-control form-control-sm" value="<?php echo isset($staff_id) ? $staff_id : '' ?>" required>
              </div>
              <div class="col-sm-6 form-group ">
